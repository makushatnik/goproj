...
func (o *GetUserInternalServerError) WithPayload(payload *models.FailResponse) *GetUserInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get user internal server error response
func (o *GetUserInternalServerError) SetPayload(payload *models.FailResponse) {
	o.Payload = payload
}
